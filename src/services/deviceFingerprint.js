...
class ClientDeviceFingerprint {
  ...
  static async collectFingerprint() {
    ...
    try {
      ...
      // Plugins
      fingerprint.plugins = await this.getPlugins();

      // Fonts
      fingerprint.fonts = await this.getFonts();
      ...
      fingerprint.geolocation = await this.getGeolocation();
   ...
   */
  static isFontAvailable(font, baseFonts) {
